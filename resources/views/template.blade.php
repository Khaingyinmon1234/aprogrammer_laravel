...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <link href="{{asset('https://fonts.googleapis.com/css?family=Muli:300,300i,400,400i,600,600i,700,700i%7CComfortaa:300,400,700" rel="stylesheet')}}">
    <link href="{{asset('https://maxcdn.icons8.com/fonts/line-awesome/1.1/css/line-awesome.min.css')}}" rel="stylesheet">
    <!-- BEGIN VENDOR CSS-->
